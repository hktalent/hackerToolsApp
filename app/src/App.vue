  ...
  <div id="app">
    <el-container>
      <el-header background="trasla">
        <el-menu ref="menu" router :default-active="activeIndex2" class="el-menu-demo" mode="horizontal"
          @select="handleCommand" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b">
      ...
      <el-container>
        ...
        <el-main>
          <el-tabs v-model="activeName" type="border-card" @tab-click="fnSt1">
            ...
            <el-tab-pane label="Remoute Config Manager" class="cfgrmt" name="RMCm1">
